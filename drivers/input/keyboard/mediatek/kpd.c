...
/* [VY36] S- BUG#1371 Grace_Chang [DMS09045563] Modify hall-sensor irq handler to avoid kernel panic */
#include <linux/workqueue.h>
/* [VY36] E- BUG#1371 Grace_Chang [DMS09045563] Modify hall-sensor irq handler to avoid kernel panic */
...
static int kpd_pdrv_probe(struct platform_device *pdev)
{
	...
	/* [VY36] S- BUG#976 Grace_Chang [DMS06707672] Modify power-key & usb behavior with hall-sensor */
	switch_set_state((struct switch_dev *)&sdev, 1);	// state initialization
	/* [VY36] E- BUG#976 Grace_Chang [DMS06707672] Modify power-key & usb behavior with hall-sensor */
	/* [VY36] S- BUG#1371 Grace_Chang [DMS09045563] Modify hall-sensor irq handler to avoid kernel panic */

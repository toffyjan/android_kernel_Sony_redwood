...
void OnInit_FT8607_TestItem(char*  strIniFile)
{
	...
	/////////////////////////////////// LCD_NOISE_TEST
	GetPrivateProfileString("TestItem", "LCD_NOISE_TEST", "1", str, strIniFile);

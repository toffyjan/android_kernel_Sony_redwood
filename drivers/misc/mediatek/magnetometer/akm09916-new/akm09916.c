...
//#define AKM_Device_AK8963		//if use AK09916 code to compatible AK8963C, need define this
//#define AKM_Device_AK09911	//if use AK09916 code to compatible AK09911, need define this
...
struct mag_hw *get_cust_mag_akm09916(void)
{
	return &mag_cust;
}
...
static long AKECS_SetMode_FUSEAccess(void)
{
	...
	return AKI2C_TxData(buffer, 2);
	#else
	return 0; // if device is AK09916 which is without FuseROM Access mode 
	#endif
}
#endif

...
// BSP_Audio_S: 20160831 FP019378:Non-CTIA headset warning message
static ssize_t switch_dev_print_name(struct switch_dev *swdev, char *buf);
// BSP_Audio_E: 20160831
...
char *accdet_report_string[4] = {
	...
	"Headset_mic",
	"Headset_no_mic",
	/*"Headset_five_pole",*/ // BSP_Audio_S: 20160831 FP019378:Non-CTIA headset warning message
	"HEADSET_illegal", // BSP_Audio_S: 20160831 FP019378:Non-CTIA headset warning message
	/* "Double_check" */
};
		...
		if (current_status == 0) {
			...
			if (current_status == 0 && show_icon_delay != 0) {
				...
				if (pin_adc_value < 180 && pin_adc_value > 90) {	/* 90mv illegal headset */
					...
					mutex_lock(&accdet_eint_irq_sync_mutex);
					if (eint_accdet_sync_flag == 1) {
#if 0  // BSP_Audio_S: 20160831 FP019378:Non-CTIA headset warning message
						cable_type = HEADSET_NO_MIC;
						accdet_status = HOOK_SWITCH;
#else
						cable_type = HEADSET_ILEGAL;
						accdet_status = MIC_BIAS_ILLEGAL;
#endif // BSP_Audio_E: 20160831
...
*/
	...
	accdet_data.print_name = switch_dev_print_name;  // BSP_Audio_S: 20160831 FP019378:Non-CTIA headset warning message

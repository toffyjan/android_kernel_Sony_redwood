...
static void set_shutter(unsigned long long shutter)
{
    ...
    if(longexposure_times>0)
    {
        ...
        LOG_INF("lxd!--1 shutter =%lld, longexposure_times=%d\n", shutter,longexposure_times);
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	if(iI < IMX300MIPI_MaxGainIndex)
    	{
        	 LOG_INF("Gain mapping don't correctly:%d %d \n", gain, IMX300MIPI_sensorGainMapping[iI][0]);
    	}
...
{
    LOG_INF("E\n");
	imx300_table_write_cmos_sensor(addr_data_pair_init_imx300, sizeof(addr_data_pair_init_imx300)/sizeof(kal_uint16));
    LOG_INF("Exit\n");
}    /*    sensor_init  */
static void preview_setting(void)
{
	...
	imx300_table_write_cmos_sensor(addr_data_pair_preview_imx300, sizeof(addr_data_pair_preview_imx300)/sizeof(kal_uint16));
	if(1 == imgsensor.pdaf_mode )
	{
		imx300_table_write_cmos_sensor(addr_data_pair_preview_imx300_pdaf, sizeof(addr_data_pair_preview_imx300_pdaf)/sizeof(kal_uint16));
	}
...
static void capture_setting(kal_uint16 currefps)
{
	...
	imx300_table_write_cmos_sensor(addr_data_pair_capture_imx300, sizeof(addr_data_pair_capture_imx300)/sizeof(kal_uint16));
	if(1 == imgsensor.pdaf_mode )
	{
		imx300_table_write_cmos_sensor(addr_data_pair_capture_imx300_pdaf, sizeof(addr_data_pair_capture_imx300_pdaf)/sizeof(kal_uint16));
	}
	write_cmos_sensor(0x0100,0x01);
}
static void normal_video_setting(kal_uint16 currefps)
{
	...
	imx300_table_write_cmos_sensor(addr_data_pair_video_imx300, sizeof(addr_data_pair_video_imx300)/sizeof(kal_uint16));
	if(1 == imgsensor.pdaf_mode )
	{
...
{
    LOG_INF("E\n");
	imx300_table_write_cmos_sensor(addr_data_pair_hs_video_imx300, sizeof(addr_data_pair_hs_video_imx300)/sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
    LOG_INF("E\n");
    //@@video_720p_60fps
    imx300_table_write_cmos_sensor(addr_data_pair_slim_video_imx300, sizeof(addr_data_pair_slim_video_imx300)/sizeof(kal_uint16));
}

static void custom1_setting(void)
{
	imx300_table_write_cmos_sensor(addr_data_pair_custom1_imx300, sizeof(addr_data_pair_custom1_imx300)/sizeof(kal_uint16));

}
static void custom2_setting(void)
{
	write_cmos_sensor(0x0100,0x00);
	imx300_table_write_cmos_sensor(addr_data_pair_custom2_imx300, sizeof(addr_data_pair_custom2_imx300)/sizeof(kal_uint16));
	if(1 == imgsensor.pdaf_mode )
	{
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:
	{
		...
		imx300_DCC_conversion((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
		break;
	}

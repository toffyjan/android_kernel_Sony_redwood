...
kal_uint16 addr_data_pair_init_imx300[] =
{
	...
	,0x305D,     0x03
	,0x31B0,     0x01 //0:Fixed area(16x12),1:Fixed area(8x6),Type of AF detection area
	,0x3208,     0x01
	,0x3210,     0x00
	,0x406C,     0x01
	,0x406D,     0x39
...
kal_uint16 addr_data_pair_capture_imx300_pdaf[] =
{
	...
	,0x3155,     0xB2 //PD_AREA_WIDTH[7:0]
	,0x3156,     0x02 //PD_AREA_HEIGHT[12:8]
	,0x3157,     0xAA //PD_AREA_HEIGHT[7:0]

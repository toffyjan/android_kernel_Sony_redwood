...
extern int setFlash_tlv61310_1(int brightness);
extern int setFlash_tlv61310_2(int brightness);
extern int setTorch_tlv61310_1(int brightness);
extern int setTorch_tlv61310_2(int brightness);
extern int restoreDuty_tlv61310_1(void);
extern int restoreDuty_tlv61310_2(void);
...
static unsigned int g_flash = 0, g_torch = 0, g_duty = 0;
#define DEFAULT_TORCH 200
#define DEFAULT_FLASH 1000
/* ======================================================================== */
/* TEST */
		...
		struct device_attribute *attr, const char *buf, size_t size)
{
	...
	if (val > 0) {
		init_tlv61310();
		g_torch = 0;
		brightness = (g_duty == 0) ? DEFAULT_FLASH : g_duty;
	}

	if (val == 3) {
		/*turn on dual flash */
		setFlash_tlv61310_1(brightness);
		setFlash_tlv61310_2(brightness);
		g_flash = 3;
	}
	else if (val == 2) {
		/*turn on sub flash */
		setFlash_tlv61310_2(brightness);
		setFlash_tlv61310_1(0);
		g_flash = 2;
	}
	else if (val == 1) {
		/*turn on main flash */
		setFlash_tlv61310_1(brightness);
		setFlash_tlv61310_2(0);
		g_flash = 1;
	}
	else {
		/*turn off flash */
		setFlash_tlv61310_1(0);
		setFlash_tlv61310_2(0);
		restoreDuty_tlv61310_1();
		restoreDuty_tlv61310_2();
		g_flash = 0;
	}
		...
		struct device_attribute *attr, const char *buf, size_t size)
{
	...
	if (val > 0) {
		init_tlv61310();
		g_flash = 0;
		brightness = (g_duty == 0) ? DEFAULT_TORCH : g_duty;
	}

	if (val == 3) {
		/*turn on dual torch */
		setTorch_tlv61310_1(brightness);
		setTorch_tlv61310_2(brightness);
		g_torch = 3;
	}
	else if (val == 2) {
		/*turn on sub torch */
		setTorch_tlv61310_2(brightness);
		setTorch_tlv61310_1(0);
		g_torch = 2;
	}
	else if (val == 1) {
		/*turn on main torch */
		setTorch_tlv61310_1(brightness);
		setTorch_tlv61310_2(0);
		g_torch = 1;
	}
	else {
		/*turn off torch */

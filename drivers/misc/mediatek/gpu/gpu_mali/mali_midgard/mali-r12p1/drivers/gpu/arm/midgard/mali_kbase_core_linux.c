...
static int kbase_platform_device_probe(struct platform_device *pdev)
{
	...
	dev_info(kbdev->dev, "power_control_init Begin()\n");
	...
	dev_info(kbdev->dev, "power_control_init End()\n");
	...
	dev_info(kbdev->dev, "mtk_platform_init Begin()\n");
	...
	dev_info(kbdev->dev, "mtk_platform_init End()\n");


	dev_info(kbdev->dev, "kbase_backend_early_init Begin()\n");
	...
	dev_info(kbdev->dev, "kbase_backend_early_init End()\n");
	kbdev->inited_subsys |= inited_backend_early;

	scnprintf(kbdev->devname, DEVNAME_SIZE, "%s%d", kbase_drv_name,
			kbase_dev_nr);

	dev_info(kbdev->dev, "kbase_disjoint_init Begin()\n");
	kbase_disjoint_init(kbdev);
	dev_info(kbdev->dev, "kbase_disjoint_init End()\n");
	...
	dev_info(kbdev->dev, "kbase_device_init Begin()\n");
	...
	dev_info(kbdev->dev, "kbase_device_init End()\n");
	kbdev->inited_subsys |= inited_device;
	...
	dev_info(kbdev->dev, "kbase_mem_init Begin()\n");
	...
	dev_info(kbdev->dev, "kbase_mem_init End()\n");
	kbdev->inited_subsys |= inited_mem;
	...
	dev_info(kbdev->dev, "kbase_device_coherency_init Begin()\n");
	kbase_device_coherency_init(kbdev, gpu_id);
	dev_info(kbdev->dev, "kbase_device_coherency_init End()\n");

	dev_info(kbdev->dev, "kbasep_secure_mode_init Begin()\n");
	kbasep_secure_mode_init(kbdev);
	dev_info(kbdev->dev, "kbasep_secure_mode_init End()\n");

	dev_info(kbdev->dev, "kbasep_js_devdata_init Begin()\n");
	...
	dev_info(kbdev->dev, "kbasep_js_devdata_init End()\n");
	kbdev->inited_subsys |= inited_js;
	...
	dev_info(kbdev->dev, "kbase_backend_late_init Begin()\n");
	...
	dev_info(kbdev->dev, "kbase_backend_late_init End()\n");
	kbdev->inited_subsys |= inited_backend_late;
	...
	dev_info(kbdev->dev, "misc_register Begin()\n");
	...
	dev_info(kbdev->dev, "misc_register End()\n");
	kbdev->inited_subsys |= inited_misc_register;

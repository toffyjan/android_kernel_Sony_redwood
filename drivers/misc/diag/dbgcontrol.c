...
#if 1
		//2016-10-10
		//dbgcontrol will work if the vaule(MiscTa 64000) is non-zero.
		if (local_option != 0)
...
//generate-modem
void __attribute__((weak)) dbgcontrol_assert_modem(void){}
...
MODULE_DESCRIPTION("ODM dbgcontrol module");
